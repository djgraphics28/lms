...
<head>
  ...
  <title>DA - BPI System | Dashboard</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
      ...
      {{-- <span class="logo-mini" style="font-size:14px!important;"><b>BPI</b></span> --}}
        <img class="logo-mini" src="{{ asset('public/dist/img/BPI-logo.png') }}" alt="BPI-logo" style="width:50px;height:auto;">
      <!-- logo for regular state and mobile devices -->
      <img class="logo-lg" src="{{ asset('public/dist/img/BPI.png') }}" alt="BPI-logo" style="width:190px;height:auto;">
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Juan de la Cruz</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-archive"></i> <span>HRIS</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="#"><i class="fa fa-circle-o"></i> Stations</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i> Department</a></li>
                <li><a href="#"><i class="fa fa-circle-o"></i> Resignation</a></li>
              </ul>
            </li>
            <li class="treeview">
                <a href="#"><i class="fa fa-folder"></i> Files
                    <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    <li class="treeview">
                    <a href="#"><i class="fa fa-file-o"></i> PDS
                        <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="#"><i class="fa fa-circle-o"></i> Info Encoding</a></li>
                        <li><a href="#"><i class="fa fa-circle-o"></i> Designation</a></li>
                        <li><a href="#"><i class="fa fa-circle-o"></i> Department</a></li>
                        <li><a href="#"><i class="fa fa-circle-o"></i> Supervisors</a></li>
                    </ul>
                    </li>
                </ul>
                </li>
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                <li><a href="#"><i class="fa fa-user"></i> User Accounts</a></li>
                <li><a href="#"><i class="fa fa-lock"></i> User Permission</a></li>
            </ul>
            </li>
      </ul>
    </section>
